...
#include "pch.h"
#include "BasicTessQuad.hpp"


using namespace std;


// Example data for basic quad
...
// Simple quad4 patch (no adjacency)
...
BasicTessQuad::BasicTessQuad() {
	...
	shaderProg = GLShaderFactory::CreateProgramObject(
		...
		GLShaderFactory::CreateShader(GL_TESS_CONTROL_SHADER, "shaders\\Tessellation\\basic_tess_quad.tcs.txt"),
		GLShaderFactory::CreateShader(GL_TESS_EVALUATION_SHADER, "shaders\\Tessellation\\basic_tess_quad.tes.txt"),
...
void BasicTessQuad::render(const glm::mat4& T) {
